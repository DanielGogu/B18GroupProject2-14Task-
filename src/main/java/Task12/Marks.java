...
class MarksTester{
    public static void main(String[] args) {
        Marks[] marksAverage={new A(65,78,41),new B(87,26,48,95)};
        for (Marks marks : marksAverage) {
            System.out.println("The average percentage of marks is "+marks.getPercentage());
        }
    }
